...
H900 = {
    ...
    # 生物学: advanced molecular/cell biology, genetics, evolution, ecology
    "adp", "calvin cycle", "electron transport chain",
    "krebs cycle (citric acid cycle)", "oxidative phosphorylation", "nadh",
    "fadh2", "messenger rna (mrna)", "transfer rna (trna)", "codon",
    "point mutation", "gene regulation", "epigenetics",
    "pcr (polymerase chain reaction)", "allele frequency",
    "hardy-weinberg equilibrium", "genetic drift", "gene flow",
    "polygenic trait", "genetic linkage", "speciation", "phylogeny",
    "common descent", "adaptive radiation", "convergent evolution",
    "trophic level", "keystone species", "mutualism", "commensalism",
    "parasitism", "ecological niche", "carrying capacity", "osmosis",
    "diffusion", "active transport", "cell signaling", "receptor (biology)",
    # 経済学: advanced micro/macro theory, behavioral & institutional econ
    "general equilibrium", "welfare economics", "pigouvian tax",
    "coase theorem", "public goods", "tragedy of the commons",
    "monopolistic competition", "price discrimination", "consumer surplus",
    "producer surplus", "edgeworth box", "is-lm model", "solow growth model",
    "endogenous growth theory", "ricardian equivalence",
    "time inconsistency", "inflation targeting", "taylor rule",
    "real business cycle theory", "sticky wages",
    "natural rate of unemployment", "output gap", "bounded rationality",
    "prospect theory", "loss aversion", "anchoring bias", "nudge theory",
    "institutional economics", "transaction cost economics",
    "heckscher-ohlin model", "terms of trade", "balance of payments",
    "purchasing power parity", "capital account", "trade liberalization",
    "regression analysis", "endogeneity", "instrumental variable",
    "causal inference", "natural experiment",
    # 経営学: advanced strategy, corporate finance, org theory
    "dynamic capabilities", "real options theory", "disruptive innovation",
    "first-mover advantage", "network effects", "economies of scope",
    "absorptive capacity", "experience curve", "coopetition",
    "net present value (npv)", "internal rate of return (irr)",
    "weighted average cost of capital (wacc)",
    "capital asset pricing model (capm)", "leveraged buyout (lbo)",
    "mergers and acquisitions (m&a)", "free cash flow", "capital structure",
    "agency cost", "poison pill", "capital budgeting", "balanced scorecard",
    "knowledge management", "organizational ambidexterity",
    "psychological safety", "high-reliability organization",
    "learning organization", "tacit knowledge", "double-loop learning",
    "customer relationship management (crm)", "brand positioning",
    "disruptive technology", "switching costs", "first-mover disadvantage",
    "two-sided market", "just-in-time (jit)", "lean management",
    "total quality management (tqm)", "supply chain resilience",
