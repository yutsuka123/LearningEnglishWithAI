# ruff: noqa: E501
"""2026-09-09に追加した陶芸ドメイン(61語)だけを対象に、単語見出し＋例文の
TTS音声を生成する。他クラスタの音声生成(build_audio_batch_2026_09_09.py
等)実行時にこのバッチを含め忘れていたための単独対応。

Run:  python scripts/build_audio_pottery_2026_09_09.py
"""
