...
ERROR_TRANSLATIONS: dict[str, tuple[str, str, str]] = {
    ...
    "3025": ("The pricing status has changed. Please refresh and try again.",
             "费用状态已变更。请刷新后重试。",
             "費用狀態已變更。請重新整理後再試。"),
    "3026": ("\"Details plus\" is not open for this word yet. Open it first, then play the audio.",
             "此单词的“详情plus”尚未打开。请先打开,再播放音频。",
             "此字的「詳情plus」尚未開啟。請先開啟,再播放音訊。"),
